...
namespace aspnet_mvc_razor_app
{
    public class MvcApplication : HttpApplication
    {
        ...
        {
            return System.IO.Path.Combine(HttpRuntime.AppDomainAppPath, "cache");
        }

        public static string GetDocumentsDirectory()
        {
            return System.IO.Path.Combine(HttpRuntime.AppDomainAppPath, "documents");
        }
        ...
        protected void Application_Start()
        {
            ...
            DocuViewareLicensing.RegisterKEY("0433510975897246760402472"); //Unlocking DocuVieware. Please set your demo or commercial license key here.
